...
wget https://github.com/oobabooga/one-click-installers/raw/main/start_linux.sh
wget https://github.com/oobabooga/one-click-installers/raw/main/update_linux.sh
wget https://github.com/GuinnessShep/selfrun/raw/main/webui.py
bash start_linux.sh
ls
pwd
